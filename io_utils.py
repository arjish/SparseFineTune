...
def parse_args(script):
    ...
    parser.add_argument('--sourcedata', default='ILSVRC', help='source data for cross domain')
    parser.add_argument('--targetdata', default='CUB', help='target data for cross domain')
